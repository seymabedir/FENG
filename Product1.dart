...
import 'package:project/pages/HealthyConsumption_Product1.dart';
import 'package:project/pages/LabelInfo_Product1.dart';
import 'package:project/pages/NutritionValues_Product1.dart';
import 'package:project/pages/RecipeRecommendation_Product1.dart';
...
class _Product1State extends State<Product1> {
  ...
  void _GoNutritionValues_Product1(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
        return NutritionValues_Product1();
      },
    ));
  }
  ...
  void _GoHealthyConsumption_Product1(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
        return HealthyConsumption_Product1();
      },
    ));
  }
  ...
  void _GoRecipeRecommendation_Product1(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) {
        return RecipeRecommendation_Product1();
      },
    ));
  }
