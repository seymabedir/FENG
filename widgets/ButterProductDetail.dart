...
class ButterProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<ButterProductDetail> createState() => _ButterProductDetailState();
}

class _ButterProductDetailState extends State<ButterProductDetail> {
  bool isFav = true;
