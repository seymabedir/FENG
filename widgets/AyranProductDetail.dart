...
class AyranProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<AyranProductDetail> createState() => _AyranProductDetailState();
}

class _AyranProductDetailState extends State<AyranProductDetail> {
  bool isFav = true;
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_ALI);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_ANV);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_AHC);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_ARR);
                },
                child: Container(
                  child: Center(
                    child: Stack(
