...
class CrabProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<CrabProductDetail> createState() => _CrabProductDetailState();
}

class _CrabProductDetailState extends State<CrabProductDetail> {
  bool isFav = true;
