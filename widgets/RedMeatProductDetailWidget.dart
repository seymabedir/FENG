...
class RedMeatProductDetailWidget extends StatefulWidget {
  ...
  @override
  State<RedMeatProductDetailWidget> createState() => _RedMeatProductDetailWidgetState();
}

class _RedMeatProductDetailWidgetState extends State<RedMeatProductDetailWidget> {
  bool isFav = true;
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.of(context)
                      .pushNamed(Constants.ROUTE_RMLI);
                },
                child: Container(
                  child: Center(
                    child: Stack(
          ...
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context)
                      .pushNamed(Constants.ROUTE_RMNV);
                },
                child: Container(
                  child: Center(
                    child: Stack(
          ...
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context)
                      .pushNamed(Constants.ROUTE_RMHC);
                },
                child: Container(
                  child: Center(
                    child: Stack(
          ...
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context)
                      .pushNamed(Constants.ROUTE_RMRR);
                },
                child: Container(
                  child: Center(
                    child: Stack(
