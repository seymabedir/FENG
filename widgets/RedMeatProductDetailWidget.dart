...
class RedMeatProductDetailWidget extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<RedMeatProductDetailWidget> createState() =>
      _RedMeatProductDetailWidgetState();
}

class _RedMeatProductDetailWidgetState
    extends State<RedMeatProductDetailWidget> {
  bool isFav = true;
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_RMLI);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_RMNV);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_RMHC);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_RMRR);
                },
                child: Container(
                  child: Center(
                    child: Stack(
