...
class IceCreamProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<IceCreamProductDetail> createState() => _IceCreamProductDetailState();
}

class _IceCreamProductDetailState extends State<IceCreamProductDetail> {
  bool isFav = true;
