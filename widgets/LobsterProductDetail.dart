...
class LobsterProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<LobsterProductDetail> createState() => _LobsterProductDetailState();
}

class _LobsterProductDetailState extends State<LobsterProductDetail> {
  bool isFav = true;
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_LLI);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_LNV);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_LHC);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_LRR);
                },
                child: Container(
                  child: Center(
                    child: Stack(
