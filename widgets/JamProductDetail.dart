...
class JamProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<JamProductDetail> createState() => _JamProductDetailState();
}

class _JamProductDetailState extends State<JamProductDetail> {
  bool isFav = true;
