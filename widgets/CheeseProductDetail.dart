...
class CheeseProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<CheeseProductDetail> createState() => _CheeseProductDetailState();
}

class _CheeseProductDetailState extends State<CheeseProductDetail> {
  bool isFav = true;
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_CheeseLI);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_CheeseNV);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_CheeseHC);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_CheeseRR);
                },
                child: Container(
                  child: Center(
                    child: Stack(
