...
class KetchupProductDetail extends StatefulWidget {
  String categoryName;
  String productName;
  String imageUrl;
  int avgRate;
  ...
  @override
  State<KetchupProductDetail> createState() => _KetchupProductDetailState();
}

class _KetchupProductDetailState extends State<KetchupProductDetail> {
  bool isFav = true;
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_KLI);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_KNV);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_KHC);
                },
                child: Container(
                  child: Center(
                    child: Stack(
        ...
        Column(
          children: [
            ClipOval(
              child: TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(Constants.ROUTE_KRR);
                },
                child: Container(
                  child: Center(
                    child: Stack(
