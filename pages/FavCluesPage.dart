...
class FavCluesPage extends StatefulWidget {
  const FavCluesPage({Key? key}) : super(key: key);

  @override
  _FavCluesPageState createState() => _FavCluesPageState();
}

class _FavCluesPageState extends State<FavCluesPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Favori İpuçları')),
      body: Container(
