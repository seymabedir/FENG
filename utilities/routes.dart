...
import 'package:project/Recipes/Ketcap.dart';
import 'package:project/Recipes/KizarmisDondurma.dart';
import 'package:project/Recipes/MeyveSuluMuhallebi.dart';
...
class Routes {
  static final routes = <String, WidgetBuilder>{
    ...
    Constants.ROUTE_ACCOUNTINFO: (BuildContext context) =>
    ...
    Constants.ROUTE_RED_MEAT: (BuildContext context) =>
        const RedMeatProductsDetail(),
    Constants.ROUTE_KETCHUP: (BuildContext context) => const KetchupDetail(),
    Constants.ROUTE_MAYONNAISE: (BuildContext context) =>
        const MayonnaiseDetail(),
    Constants.ROUTE_FRUITJUICE: (BuildContext context) =>
        const FruitJuiceProductDetail(),
    ...
    Constants.ROUTE_DUSES_PATATES: (BuildContext context) =>
        const DusesPatates(),
    Constants.ROUTE_PEYNIR_CUBUKLARI: (BuildContext context) =>
        const PeynirCubuklari(),
    Constants.ROUTE_HAMSILI_PILAV: (BuildContext context) =>
        const HamsiliPilav(),
    Constants.ROUTE_MEYVESULU_MUHALLEBI: (BuildContext context) =>
        const MeyveSuluMuhallebi(),
    Constants.ROUTE_KIZARMIS_DONDURMA: (BuildContext context) =>
        const KizarmisDondurma(),
    Constants.ROUTE_KETCAP: (BuildContext context) => const Ketcap(),
  };
}