...
class LabelInfo_Product1 extends StatefulWidget {
  const LabelInfo_Product1({Key? key}) : super(key: key);

  @override
  _LabelInfo_Product1State createState() => _LabelInfo_Product1State();
}

class _LabelInfo_Product1State extends State<LabelInfo_Product1> {
  @override
