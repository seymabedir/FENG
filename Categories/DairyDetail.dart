...
class _DairyDetailState extends State<DairyDetail> {
  ...
  _buildCategoryDetailWidget(context) {
    return CategoryDetailWidget(
      ...
      info: "Bu grupta yer alan başlıca besinler süt, yoğurt ve peynirdir. "
          "\n Süt grubu besinler protein, kalsiyum, B2 vitamini (riboflavin) ve B12 vitamini "
          "\n başta olmak üzere birçok besin ögesinin önemli kaynağıdır. "
          "\n Süt grubu besinlerde bulunan kalsiyum diğer besin kaynaklarına göre vücut tarafından "
          "\n daha iyi kullanılır. Kalsiyum kemiklerin ve dişlerin sağlıklı gelişiminde "
          "\n ve hücre çalışmasında önemli rol oynar. Süt ve süt ürünlerinin içerdiği kaliteli protein "
          "\n her yaş grubunda vücudun çalışması; çocukluk döneminde büyüme, yetişkinlikte ise "
          "\n doku onarımının sağlanması için gereklidir. "
          "\n Bu grupta yer alan besinlerde bulunan B vitaminleri, başta kırmızı kan hücreleri ile "
          "\n sinir hücreleri olmak üzere tüm vücutta önemli işlevlere sahiptir. "
