...
class ButterLI extends StatelessWidget {
  const ButterLI({Key? key}) : super(key: key);
  ...
  _Label() {
    return LabelInfoWidget(
      ...
      productInfo: "\n En az %80 süt yağı içerir. "
          "\n İçindekiler: Pastorize Inek Sütü Kreması, Tereyağı Kültürü, Tuz (maksimum 962). Alerjen Uyansı: Süt ürünüdür. En fazla +4°C'de muhafaza ediniz. Son Tüketim Tarihi (S.T.T.) ve Parti No ambalaj üzerinde olup Son Tüketim Tarihinden önce tüketilmelidir.",
    );
  }
