...
class CheeseLI extends StatelessWidget {
  const CheeseLI({Key? key}) : super(key: key);
  ...
  _Label() {
    return LabelInfoWidget(
      ...
      productName: "PEYNİR",
      productInfo:
          "İçindekiler: Pastörize inek sütü, peynir mayası, peynir kültürü, tuz. +4°C the 10°C  arasında muhafaza ediniz Türk Gıda Kodeksi Peynir Tebliğine uygundur. Son Tüketim Tarih (STT) yan yüzdedir.",
    );
  }
